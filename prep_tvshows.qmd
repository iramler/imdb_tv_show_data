...
library("arrow")
# Directly specify the file name instead of using tempfile()
parquet = file.path(getwd(), "popular_tv_shows.parquet")
write_parquet(popular_tv_shows |> select(-parentTconst), sink = parquet)
